  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative w-[946px] my-6 mx-auto ">
          {/*content*/}
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-[#111212] outline-none focus:outline-none">
            {/*header*/}

            <div className="pt-[33px] relative">
              <div className="flex items-center justify-between mb-[10px] pl-[67px] pr-[56px]">
                <p className="text-[24px] font-[600] text-[#B1B1B1]">{name}</p>
                <img
                  src={zoomOut}
                  alt=""
                ...
                <div className="flex gap-[11px] items-center">
                  <button
                    className={`text-[20px] font-[400]  text-[#666666] ${
                      activeTime === "24h" &&
              ...
              <div className="flex items-center justify-between pl-[67px] pr-[56px]">
                <p className="text-[48px] font-[600]">{number}</p>
                <div className="flex gap-[9px]">
                  <button
                    className={`${
                      activeLine.includes("token") && "border border-[#14F092]"
                    } rounded-[4px] py-[6px] px-[32px]  text-[14px] font-[600]`}
                    onClick={() => handleActiveLIne("token")}
                  >
                    Token
                  </button>
                  <button
                    className={`flex items-center gap-[7px] text-[14px] font-[400] text-[#CDCDCD] ${
                      activeLine.includes("benchmark") &&
                      "border border-[#59F5FF]"
                    } rounded-[4px] py-[6px] px-[16px]`}
                  ...
                  <button
                    ...
                    } flex items-center gap-[7px] text-[14px] font-[400] text-[#CDCDCD]  rounded-[4px] py-[6px] px-[16px]`}
