  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap lg:flex-nowrap gap-[26px]">
        <div className="px-[20px] pt-[20px] bg-[#111212] rounded-[6px] ">
        ...
        <div className="w-full">
          ...
          <div className=" bg-[#111212] rounded-[6px] px-[20px] pt-[20px] w-full ">
            ...
            <div className="overflow-x-scroll no-scrollbar ">
              <table className="w-full whitespace-nowrap topWalletTable">
                <thead>
                  <tr className="border-b border-[#212123] text-[12px] font-[400] text-[#B1B1B1] ">
                    <th className="text-start pb-[9px]">Wallet Address</th>
                    <th className="text-end">Persona</th>
                    <th className="text-end">% Token Held</th>
                    <th className="text-end"># of Tokens</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="text-start text-[14px] font-[600] pb-[9px]">
                      0xa8a70d27416abba60...
                    </td>
